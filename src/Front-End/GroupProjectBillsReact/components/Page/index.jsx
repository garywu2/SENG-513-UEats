...
function Page() {
  return (
    <div className="page">
      <img className="chevron-down-1" src="/img/chevron-down-11@2x.png" alt="chevron-down" />
      ...
      <img className="chevron-down-1" src="/img/chevron-down-12@2x.png" alt="chevron-down" />
    </div>
  );
}
