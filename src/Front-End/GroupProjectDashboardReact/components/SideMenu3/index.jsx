...
import "./SideMenu3.sass";

function SideMenu3(props) {
  const { dashboard2Props, foodOrder1Props, foodOrder2Props, foodOrder3Props } = props;
    ...
    <div className="side-menu">
      <div className="overlap-group1-3">
        ...
        <div className="overlap-group-4">
          ...
          <img className="mask-group" src="/img/mask-group-37@2x.png" alt="Mask Group" />
          <div className="add-button">
            <div className="upgrade poppins-semi-bold-thunder-14px">
              <span className="poppins-semi-bold-thunder-14px">Upgrade</span>
            </div>
          </div>
          <img className="vector-1" src="/img/vector-17@2x.png" alt="Vector" />
